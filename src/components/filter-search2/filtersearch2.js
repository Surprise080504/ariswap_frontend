    ...
    return(
        <React.Fragment>
             <div className="filter-wrapper">
                ...
                <div className="status-wrapper d-flex">
                <div><span><b>Collection</b></span></div><div><i className="fas fa-chevron-down"/></div>
                </div>
                <div className="statuses-boxex" style={{border:"none"}}>
                <i className="fas fa-search"/> <input type="search" className="on-auction placeholder-wrapper position-relative" placeholder="Filter"/>
                </div>
                <div className="d-flex justify-content-around statuses-boxex" style={{border:"none",paddingTop:"0"}}>
                  <div className="d-flex align-items-center"><div className="collection-img"></div><span className="ml-2">Sample V3</span></div>
                  <div>1</div>
                </div>
              </div>
        </React.Fragment>
